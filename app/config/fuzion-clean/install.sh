...
CIVI_DOMAIN_NAME="Fuzion Customer site"
CIVI_DOMAIN_EMAIL="\"Fuzion Customer\" <info@example.org>"
...
CIVI_EXT_DIR="${WEB_ROOT}/sites/${DRUPAL_SITE_DIR}/civicrm/extensions"
CIVI_EXT_URL="${CMS_URL}/sites/${DRUPAL_SITE_DIR}/civicrm/extensions"
CIVI_UF="Drupal"
